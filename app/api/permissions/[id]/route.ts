  ...
  async (request: NextRequest, { params }: { params: RouteParams }) => {
    try {
      ...
      return NextResponse.json({
        data: permission,
        message:
          "Permission updated successfully. Users with roles using this permission will need to refresh their tokens.",
      });
    } catch (error: any) {
...
export const DELETE = withPermission(
  ...
  async (request: NextRequest, { params }: { params: RouteParams }) => {
    try {
      ...
      return NextResponse.json({
        message:
          "Permission deleted successfully. Users with roles using this permission will need to refresh their tokens.",
      });
    } catch (error) {
